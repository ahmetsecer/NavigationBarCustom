...
class _HomeState extends State<Home> with TickerProviderStateMixin<Home> {
  static const List<Destination> allDestinations = <Destination>[
    Destination(0, 'Amber', Icons.home, Colors.amber),
    Destination(1, 'Purple', Icons.public, Colors.purple),
    Destination(2, 'DeepOrange', Icons.departure_board, Colors.deepOrange),
    Destination(3, 'Pink', Icons.pedal_bike_outlined, Colors.pink),
  ];
                      ...
                      builder: (BuildContext context) {
                        return Container(
                          ...
                          child: Text(
                            ...
                            'Kapatmak için geri düğmesine dokunun',
                            style: headlineSmall,
                            softWrap: true,
              ...
              child: OutlinedButton(
                style: buttonStyle.copyWith(
                  backgroundColor: MaterialStatePropertyAll<Color>(
                    Color.lerp(destination.color[80], Colors.white,
                        index / itemCount)!,
                  ),
                ),
                onPressed: () {
...
class _TextPageState extends State<TextPage> {
  ...
  void initState() {
    super.initState();
    textController = TextEditingController(text: 'Örnek Yazi');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      backgroundColor: widget.destination.color[10],
      body: Container(
